# Source Rmd: ERGM/ERGM_Analysis/ERGM_Result2.Rmd
...
compute_centrality_stats <- function(net) {
  ...
  E(g)$inv_weight <- 1 / E(g)$w_scale
  
  #used_weight <- E(g)$w_scale
...
obs_cent_stats <- compute_centrality_stats(net_wire)
